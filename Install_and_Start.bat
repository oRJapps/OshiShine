...
rem 4. 必要なライブラリのインストール (requirements.txt から)
echo [情報] ライブラリをチェック・インストール中だ...
python -m pip install --upgrade pip >nul 2>&1
pip install -r requirements.txt

rem 5. AIモデルの存在チェック（超重要！）
if not exist model\midas_v21_small_256.pt (
    echo.
    echo ==========================================
    echo [警告] 待ってくれ！AIモデルファイルが見つかりません
    echo.
    echo 'model' フォルダの中に 'midas_v21_small_256.pt' を入れてくれ。
